<template>
  <nav class="flex flex-wrap items-center justify-between py-3 bg-dark navbar-expand-lg mb-3" style="background-color: #232323;">
    <div class="container mx-auto flex flex-wrap items-center px-5 justify-between">
      ...
      >
        <a
          v-scroll-to="'#profile'"
          aria-label="Profile"
          class="font-bold leading-relaxed inline-block mr-2 py-2 whitespace-no-wrap uppercase text-white text-2xl hover:opacity-75"
          href="#"
        >
