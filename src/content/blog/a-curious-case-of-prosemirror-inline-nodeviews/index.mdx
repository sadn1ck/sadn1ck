...
![An issue mention in Linear](linear-issue-mention.png)

I inspect the DOM.

![Spans added by Linear before and after nodeViews](span-of-hope.png)
...
![Hmm I wonder what I'll get](search.png)

[Forum post ↗](https://discuss.prosemirror.net/t/after-setting-it-to-display-flex-the-cursor-is-mispositioned/4484/2)

![Marijn Haverbeke, ProseMirror author says having flex inside inline nodes is a bad idea](the-final-result.png)
