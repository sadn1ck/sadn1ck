...
<img widht='64' height='64' src="https://cdn.7tv.app/emote/6484f9b6f64f0ac1a08ab777/2x.webp" alt="..." width="64" height="64" />

It happens again.

_WTF_

<img width="100%" style="aspect-ratio: auto" src={theBug.src} alt="WHAT IS THIS" />
...
<img widht='64' height='64' src="https://cdn.7tv.app/emote/64047fa6871734dcee8efc4a/2x.webp" alt="I do some thonking" />

Oh I can also mention issues, might as well try that.

<Image src={linearIssueMention} alt="An issue mention in Linear" />

I inspect the DOM.

<Image src={spanOfHope} alt="Spans added by Linear before and after nodeViews" />
...
<Image src={search} alt="Hmm I wonder what I'll get" />

[Forum post ↗](https://discuss.prosemirror.net/t/after-setting-it-to-display-flex-the-cursor-is-mispositioned/4484/2)

<Image src={theFinalResult} alt="Marijn Haverbeke, ProseMirror author says having flex inside inline nodes is a bad idea" />
...
<iframe src="https://pm-inline-nodeview-blog.vercel.app/" width="100%" height="400px" style="border: 0; border-radius: 4px; overflow: hidden;" title="A curious case of ProseMirror inline node(views)" loading="lazy"></iframe>
