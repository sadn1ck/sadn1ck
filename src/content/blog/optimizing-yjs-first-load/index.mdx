...
<CustomImage src={benchAndResults} alt="Benchmark results of random updates to a Y.Map" />
...
<CustomVideo caption="Switching documents in Chronicle" src={switching} type="video/webm" />
...
<CustomVideo caption="Post-optimization loading in Chronicle" src={yjsLoad} type="video/webm" />
