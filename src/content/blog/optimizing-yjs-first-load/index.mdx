...
![Benchmark results of random updates to a Y.Map](bench-and-results.png)
...
![Comparison of a large Chronicle document in both encoding methods](encodeStateAsUpdateComparison.png)
...
![The Yjs sync flow diagram, from Peter Wooden's article about Yjs sync and awareness](sync-flow.webp)
...
![Updates and state vector in IndexedDB](updates-idb.png)
...
<video controls src={switching} title="Switching documents in Chronicle"></video>
...
<video controls src={yjsLoad} title="Post optimization of loading Chronicle"></video>
