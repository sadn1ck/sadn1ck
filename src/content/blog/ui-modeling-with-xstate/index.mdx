...
description: A short blog post on how to model simple UI interactions with XState
date: "2024-02-03"
tags: ["xstate", "ui", "state modeling"]
---

import xstateVideo from "./xstate.mp4";
...
<CustomVideo src={xstateVideo} type="video/mp4" caption="The modeled interaction" />
...
<iframe
  src="https://stackblitz.com/edit/vitejs-vite-tqbjy7?ctl=1&embed=1&file=src%2Fmachine.ts&hideNavigation=1"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
  title="Modeling Interactions w/ XState"
  loading="lazy"
></iframe>
