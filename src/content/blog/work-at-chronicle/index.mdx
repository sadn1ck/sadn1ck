...
<CustomVideo
  src={canvasBefore}
  type="video/webm"
  caption="Freeform canvas prototype"
  loop
  loading="lazy"
  aria-label="Freeform canvas prototype we built at Chronicle"
/>
...
<CustomVideo
  src={canvasAfter}
  type="video/webm"
  caption="Freeform canvas in production, December 2024"
  loop
  loading="lazy"
  aria-label="Freeform canvas in production as of December 2024"
/>
