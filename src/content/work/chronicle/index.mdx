...
<Image src={mention} alt="Mention" />

It has the potential to be one of the most fundamental ways of information visualization when working with discrete entities. As of now, you can mention people, companies, with the infra setup to also enable other Chronicle specific entities to be "mentioned".
...
<Image src={allMentions} alt="Mentions on various rich text widgets" />
...
<Image src={titleMention} alt="Mention on title screen" />
...
<Image src={storylinev1} alt="Storyline v1" />
...
<Image src={storylinev2} alt="Storyline v2" />
...
<Image src={madeWidgets} alt="Made widgets" />
